  ...
  return (
    ...
    <div className="mb-6 flex justify-center">
      ...
      >
        ...
        />
        <motion.path
          d="M32.9204 4.65517C34.4908 2.06112 37.461 0.344828 41.1327 0.344828H55.7168C55.9905 0.344828 56.2124 0.560968 56.2124 0.827586V27.1034C56.2124 27.3701 55.9905 27.5862 55.7168 27.5862H48.9911C48.7174 27.5862 48.4956 27.3701 48.4956 27.1034V21.5172H46.1809L41.6427 27.2127C41.455 27.4483 41.166 27.5862 40.8598 27.5862H32.3748C31.9627 27.5862 31.7306 27.1246 31.9834 26.8074L36.8831 20.6582C35.325 19.9666 34.0437 18.8956 33.1521 17.5862C31.8793 15.7169 31.3628 13.3618 31.3628 10.931C31.3628 8.6908 31.8363 6.44582 32.9204 4.65517ZM41.5575 7.93103C41.0883 7.93103 40.708 8.30155 40.708 8.75862V13.1034C40.708 13.5605 41.0883 13.931 41.5575 13.931H47.5752C48.0444 13.931 48.4248 13.5605 48.4248 13.1034V8.75862C48.4248 8.30155 48.0444 7.93103 47.5752 7.93103H41.5575Z"
          fill="#e53740"
          initial={{ opacity: 0, x: 20 }}
          animate={{ opacity: 1, x: 0 }}
  ...
  {['login', 'register'].map((tab) => (
    <button
      ...
      className={`relative px-4 py-2 font-semibold transition-colors duration-300 ${
        activeTab === tab ? 'text-[#e53740]' : 'text-gray-400'
      }`}
    >
      ...
      {activeTab === tab && (
        <motion.div
          layoutId="underline"
          className="absolute left-0 right-0 -bottom-1 h-0.5 bg-[#e53740] rounded"
      ...
      <form onSubmit={activeTab === 'login' ? handleLogin : handleRegister} className="space-y-4">
        ...
        <input
          ...
          required
        />
        <button type="submit" className="bg-[#e53740] text-white px-4 py-2 rounded w-full">
          {activeTab === 'login' ? 'Войти' : 'Зарегистрироваться'}
        </button>
      </form>

      {message && <p className="mt-4 text-center text-[#e53740]">{message}</p>}
    </div>
    </div>
  )
}
