    ...
    <div className="max-w-md mx-auto p-4 border rounded shadow">
      <div className="flex justify-around mb-6">
        <button
          ...
          className={`px-4 py-2 font-semibold ${activeTab === 'login' ? 'border-b-2 border-red-600 text-red-500' : 'text-gray-500'}`}
        >
          Вход
        </button>
        <button
          onClick={() => setActiveTab('register')}
          className={`px-4 py-2 font-semibold ${activeTab === 'register' ? 'border-b-2 border-red-600 text-red-500' : 'text-gray-500'}`}
        >
          Регистрация
        </button>
      </div>
