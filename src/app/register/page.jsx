...
export default function RegisterPage() {
  ...
  {['login', 'register'].map((tab) => (
    <button
      ...
      className={`relative text-[24px] px-4 py-2 font-semibold transition-colors duration-300 ${
        activeTab === tab ? 'text-[#e53740]' : 'text-[#d4d4d4]'
      }`}
    >
      ...
      <form onSubmit={activeTab === 'login' ? handleLogin : handleRegister} className="mt-10 space-y-4">
        <input
          type="email"
          placeholder="Email"
          value={email}
          onChange={e => setEmail(e.target.value)}
          className="w-full rounded-full border bg-[#d4d4d4] px-8 py-4 rounded"
          required
        />
        <input
          type="password"
          ...
          required
        />
        <button type="submit" className="w-full text-[#eeeeee] text-[20px] rounded-full bg-[#e53740] px-8 py-4 rounded">
